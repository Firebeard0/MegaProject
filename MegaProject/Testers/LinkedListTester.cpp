...
//  MegaProject
//
//  Created by Uffens, Noah on 2/15/18.
...
void LinkedListTester :: testListBasics()
{
    ...
    numbers.add(9);
    cout << numbers.getFront() -> getData() << "Is is at the front of the list nad should be 9" << endl;
    ...
    cout << numbers.getFront() -> getData() << "Is is at the front of the list nad should be 2312" << endl;
    cout << cumbers.getEnd() -> getData() << " Is at the end of the list and should be 32567" << endl;
}
...
void LinkedListTester ::testListWithData()
{
    ...
    LinkedList<CrimeData> crimes = FileController :: readToList ("/Users/nuff6998/Documents/SwiftCode/MegaProject/MegaProject/Data/crime.csv");
    listTimer.stopTimer();
